...
const NE_OFF_OL: Player[] = [
  { display: "J. Hudson",     initials: "JH", ringType: "ol", badgeType: "ol", badgeLabel: "LT · #51", size: 40 },
  { display: "A. Vera-Tucker",initials: "AV", ringType: "ol", badgeType: "ol", badgeLabel: "LG · #75", size: 40 },
  { display: "B. Brown",      initials: "BB", ringType: "ol", badgeType: "ol", badgeLabel: "C · #77",  size: 40 },
  { display: "M. Onwenu",     initials: "MO", ringType: "ol", badgeType: "ol", badgeLabel: "RG · #71", size: 40 },
  { display: "M. Moses",      initials: "MM", ringType: "ol", badgeType: "ol", badgeLabel: "RT · #76", size: 40 },
];
...
const SEA_OFF_OL: Player[] = [
  { display: "C. Cross",     initials: "CC", ringType: "ol", badgeType: "ol", badgeLabel: "LT · #67", size: 40 },
  { display: "J. Sundell",   initials: "JS", ringType: "ol", badgeType: "ol", badgeLabel: "LG · #61", size: 40 },
  { display: "O. Oluwatimi", initials: "OO", ringType: "ol", badgeType: "ol", badgeLabel: "C · #55",  size: 40 },
  { display: "A. Bradford",  initials: "AB", ringType: "ol", badgeType: "ol", badgeLabel: "RG · #75", size: 40 },
  { display: "A. Lucas",     initials: "AL", ringType: "ol", badgeType: "ol", badgeLabel: "RT · #72", size: 40 },
];
